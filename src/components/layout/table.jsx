    ...
    <div className="table">
      <div className="container">
        ...
        <div className="table-text">
          <p className="tabel-p">Reservations</p>
          ...
          <h1 className="tabel-h1">Book A Table</h1>

        </div>
        <div className="tabel-email">
          <form className='form'>
            <select name="" id="" className='tabel-input'>
        ...
        <div >
          <button className='banner-text-button'>Book Now</button>
        </div>
        </div>
      </div>
    </div>
