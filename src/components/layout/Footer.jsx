                ...
                <div className="container">
                    <div className="footer-top">
                        <div className="footer-text">
                            <p className="footer-text-p1">Newsletter</p>
                            <svg
                                width="40"
                                height="9"
                                viewBox="0 0 40 9"
                            ...
                            >
                                <g clip-path="url(#clip0_566_1679)">
                                    <path
                            ...
                            <p className="footer-text-p2">
                                Subscribe To Our Newsletter
                            </p>
                            <a href="#" className="footer-text-p3">
                                And never miss latest Updates!
                            </a>
                        </div>
                        <div className="footer-eml">
            ...
            <div className="footer-botton">
                <div className="container">
                    ...
                    <div className="footer-b1">
                        <p className="fot-b1-p1">Contact Us</p>
                        <a className="fot-b1-p2" href="#">9 W 53rd St, New York, NY 10019, USA</a>
                        <a className="fot-b1-p2" href="#">+1 212-344-1230</a>
                        <a className="fot-b1-p2" href="#">+1 212-555-1230</a>
                    </div>
                    <div className="footer-b1">
                        <p className="fot-b2-p1">Gerícht</p>
                        <p className="fot-b2-p2">
                    ...
                    <div className="footer-b1">
                        <p className="fot-b1-p1">Working Hours</p>
                        <a className="fot-b1-p2" href="#">Monday-Friday: 
                        <br />
                        08:00 am -12:00 am</a>
                        <br />
                        <a className="fot-b1-p2" href="#">Saturday-Sunday:
                        07:00am -11:00 pm</a>
                    </div>
                    </div>
            <div>
                <p className="fot-cen">2021 Gerícht. All Rights reserved.</p>
            </div>
                </div>
            </div>
        </div>
