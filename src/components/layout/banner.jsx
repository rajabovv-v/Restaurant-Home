        ...
        <div className="container">
            <div className="banner-row">
                <div className="banner-text">
                    <div>
                        <p className="banner-text-p1">Chase the new Flavour</p>
                    ...
                    <h1 className="banner-text-h1">The Key To Fine Dining</h1>
                    <p className="banner-text-p2">Sit tellus lobortis sed senectus vivamus molestie. Condimentum volutpat morbi facilisis quam scelerisque sapien. Et, penatibus aliquam amet tellus </p>
                    <button className="banner-text-button">Explore Menu</button>
                </div>
